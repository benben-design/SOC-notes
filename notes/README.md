...
`NN-<room-name>.md` — מספר סידורי לפי **סדר ההשלמה בפועל**, ואז שם החדר באנגלית kebab-case.
המספור שומר על סדר כרונולוגי בתצוגה, כי GitHub ממיין לפי א-ב.

דוגמה: `01-foundations/03-soc-fundamentals.md` — החדר השלישי שהשלמתי בקטגוריית היסודות.

המספור רץ בנפרד בכל קטגוריה. חדר חדש מקבל את המספר הבא הפנוי בתיקייה שלו.
